...
public class ArcherTowerUpgradeNotifyUI : MonoBehaviour 
{
    ...
    private void ArcherTower_UnUpgradeLevelProgress(object sender, System.EventArgs e) {
        ...
        if (archerTower.GetCurrentTowerStatus().levelTower == ITowerObject.LevelTower.Level1) {
            return;
        }
    ...
    private void UpdateVisual() {
        ...
        ArcherTowerLevelData currentLevelData = archerTower.GetCurrentTowerStatus();
        ArcherTowerLevelData oldLevelData = archerTower.GetArcherTowerDataDict()[(ITowerObject.LevelTower)((int)currentLevelData.levelTower - 1)];
        ...
        if (oldLevelData.levelTower == ITowerObject.LevelTower.Level1) {
            ...
            oldAttackRangeValue = archerTower.GetArcherTowerSO().baseRange;
        }
        else {
